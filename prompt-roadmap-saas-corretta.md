...
| 13-14 | Model routing, multilingua | Model routing: base gettonata (llm_routing cheap/premium con intent; task 13 da completare con budget token legato a Stripe e fallback provider). Multilingua non affrontata |
