# Graph Report - whatsapp-ai-responder  (2026-08-01)

## Corpus Check
- 296 files · ~682,135 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3761 nodes · 5534 edges · 247 communities (214 shown, 33 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 136 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `99952111`
...
2. `CoreRepository` - 69 edges
3. `TailwindConfigGenerator` - 58 edges
4. `WhatsAppService` - 37 edges
5. `TestTailwindConfigGenerator` - 35 edges
6. `ShadcnInstaller` - 34 edges
7. `BookingService` - 33 edges
8. `AppConfig` - 33 edges
9. `TestShadcnInstaller` - 26 edges
10. `handle_stripe_webhook()` - 25 edges

## Surprising Connections (you probably didn't know these)
- `main()` --calls--> `Repository`  [EXTRACTED]
  run_supervisor.py → src/whatsapp/repository.py
...
### Community 0 - "app.js"
Cohesion: 0.02
Nodes (80): availabilityDate, availabilityList, bookingCalendarEl, bookingCount, bookingDayLabel, bookingDayList, bookingDetail, bookingForm (+72 more)
...
### Community 3 - "main.py"
Cohesion: 0.08
Nodes (51): middleware, carica_documento(), carica_file_documento(), chiedi_documenti(), conteggio_documenti(), crea_prenotazione(), elenca_configurazioni(), elenco_documenti() (+43 more)
...
Cohesion: 0.09
Nodes (39): Enum, costruisci_system_prompt(), costruisci_user_prompt(), formatta_cronologia(), prompts.py ---------- Qui costruiamo il testo che l'agente riceve come…, Trasforma gli ultimi N scambi in testo per il prompt., Genera le istruzioni di ruolo per l'agente, basate sul profilo dell'attività…, Il messaggio del cliente così com'è, con la data odierna per risolvere date… (+31 more)

### Community 10 - "Repository"
Cohesion: 0.05
Nodes (6): run_retention(), UUID, Atomically marks a message as replied+handled. Returns the updated row if this…, Periodic heartbeat — tells the reaper this claim is still alive., Libera i claim rimasti bloccati oltre timeout_minutes. Per i messaggi usa…, Repository
...
Cohesion: 0.14
Nodes (16): main(), main(), AppConfig, load_tenant_config(), UUID, UUID, TemplateSyncer, app_config() (+8 more)
...
### Community 32 - "test_reviews_api.py"
Cohesion: 0.05
Nodes (35): skipif, async_client(), fixture, set_env(), async_client(), _headers(), org_id(), fixture (+27 more)
...
Cohesion: 0.07
Nodes (48): audit_log(), get_plan(), Plan, billing_webhook(), CheckoutSessionRequest, create_checkout_session(), create_portal_session(), _get_stripe() (+40 more)
...
Cohesion: 0.18
Nodes (21): onboarding_preview(), onboarding_profilo(), onboarding_salva_profilo(), onboarding_verticali(), build_business_profile(), _ensure_store_dir(), generate_preview(), get_active_profile() (+13 more)
...
### Community 46 - "time"
Cohesion: 0.05
Nodes (44): date, enhance_prompt(), generate_batch(), generate_logo(), load_env(), main(), Enhance the logo prompt with style and industry modifiers, Generate a logo using Gemini models with image generation Args: aspect_ratio:… (+36 more)
...
Cohesion: 0.26
Nodes (20): claim_ticket(), _get_app_config(), get_ticket(), _get_wrepo(), list_tickets(), get, post, Request (+12 more)
...
Cohesion: 0.13
Nodes (12): Dipendenza da combinare DOPO require_ruolo sui Tier-1. Esempio: user =…, require_mfa(), _build_test_app_real(), FastAPI, Audit 1.4 — AAL2 (MFA) step-up gate sui Tier-1 sensibili. Cosa si testa qui: 1.…, Conferma che un token proveniente da un altro progetto Supabase (issuer…, Test end-to-end con TestClient: un utente senza MFA che chiama /api/gdpr/export…, App minimale che monta /api/gdpr/export protetto da require_mfa(), per testare… (+4 more)

### Community 67 - "TestInboxAPI"
Cohesion: 0.29
Nodes (3): Task 6: non si puo' rispondere a un ticket non CLAIMED da te., Task 6: risposta manuale inoltrata a Meta Cloud API (mockata, niente rete…, TestInboxAPI

### Community 69 - "vector_store.py"
Cohesion: 0.19
Nodes (14): callable, SentenceTransformer, _modello(), vettorizza(), rispondi(), aggiungi(), cerca(), _collezione() (+6 more)
...
Cohesion: 0.17
Nodes (18): ottieni_report(), stato_report(), avvia_scheduler(), _calendar_sync_job(), genera_e_caching(), get_report_cache(), _no_show_check_job(), _nonce_cleanup_job() (+10 more)
...
### Community 78 - "test_google_reviews_api.py"
Cohesion: 0.07
Nodes (39): _get_client_config(), _get_service(), google_reviews_auth(), google_reviews_disconnect(), google_reviews_oauth2callback(), google_reviews_settings(), google_reviews_status(), google_reviews_sync() (+31 more)
...
Cohesion: 0.21
Nodes (14): LLM, crea_review_agent(), crea_review_crew(), crea_review_task(), Agent, Crew, Task, costruisci_system_prompt_review() (+6 more)
...
### Community 90 - "RetryWorker"
Cohesion: 0.21
Nodes (7): RetryWorker, app_config(), mock_repo(), mock_service(), mock_tenant(), fixture, TestRetryWorker
...
Cohesion: 0.20
Nodes (11): ABC, FonteRecensioni, FonteGoogle, Fonte Google Business Profile. Il fetch delle review passa da…, FonteManuale, FonteTripAdvisor, RecensioneInput, Fonti recensioni: ingresso manuale per TripAdvisor/Manuale. Dopo la decisione… (+3 more)
...
### Community 109 - "apply_status_update"
Cohesion: 0.20
Nodes (3): main(), apply_status_update(), TestApplyStatusUpdate
...
### Community 118 - "test_review_fixes.py"
Cohesion: 0.21
Nodes (15): calcola_priorita(), calcola_priorita_recensione(), Priorita, str, asyncio, parametrize, test_approve_review_concurrent_double_click_ends_consistent(), test_approve_review_idempotent_when_already_pubblicata() (+7 more)
...
Cohesion: 0.20
Nodes (13): _handle_inbound_message(), _create_org_with_contact_and_booking(), Helper: crea organizzazione + contatto + booking + conversation., Se increment_message_usage fallisce, il messaggio NON viene salvato., Soft-delete contatto: booking rimane intatto, conversation deleted_at settato., Hard-delete contatto: booking.contact_id = NULL, nome/telefono = 'REDACTED'., Hard-delete contatto: CASCADE elimina conversation e contact_consent_log., delete_organization attiva il trigger BEFORE DELETE su contacts che anonimizza… (+5 more)
...
### Community 131 - "reviews/routes.py"
Cohesion: 0.30
Nodes (14): approve_review(), _get_repo(), get_review(), list_reviews(), get, post, Request, Approvazione one-click della bozza risposta. Multi-tenant: una recensione di… (+6 more)
...
### Community 144 - "_audit"
Cohesion: 0.19
Nodes (16): _audit(), elimina_documento_api(), delete, put, Request, Registra un'azione sensibile in audit_log. No-op sicuro se repo o…, rimuovi_configurazione(), salva_impostazioni_prenotazioni() (+8 more)

### Community 145 - "Task 9 — Google Reviews: Cambiamenti apportati"
Cohesion: 0.17
Nodes (11): Email service exception handling, File modificati, File nuovi, Google Reply API (updateReply), Piani futuri (non implementati in questa task), Spike eseguiti, `src/api/main.py`, `src/core/db/migrations/022_reviews_ext.sql` (+3 more)

### Community 146 - "router.py"
Cohesion: 0.17
Nodes (11): dedup_check(), Atomic idempotency check via INSERT ON CONFLICT DO NOTHING. Returns True if…, create_router(), _handle_status_update(), Request, Legge il body con limite di dimensione, supporta chunked encoding., _read_limited_body(), app_config() (+3 more)
...
### Community 152 - "TenantConfig"
Cohesion: 0.36
Nodes (7): TenantConfig, app_config(), fake_tenant_config(), mock_repo(), mock_service(), fixture, sample_msg()

### Community 153 - "primitive"
Cohesion: 0.18
...
### Community 160 - "test_hitl_repository.py"
Cohesion: 0.53
Nodes (5): extended_pool(), fixture, repo(), reset_db(), reset_extended_db()
...
### Community 162 - "inviaRecensione"
Cohesion: 0.40
Nodes (6): aggiornaPrioritari(), aggiornaRiepilogo(), aggiornaTrends(), approvaRecensione(), inviaRecensione(), _paroleChiave()
...
Cohesion: 0.19
Nodes (8): AsyncClient, get_http_client(), _get_supabase_jwks(), is_demo_mode(), _load_project_env(), verify_supabase_jwt(), Audit 1.4: verify_supabase_jwt deve validare l'issuer (iss), non solo…, TestVerifySupabaseJwtIssuer
...
### Community 177 - "padding-y"
Cohesion: 0.67
Nodes (4): padding-y, padding-y, $type, $value

### Community 178 - "inbox/test_routes.py"
Cohesion: 0.67
...
### Community 181 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 182 - "destructive-foreground"
Cohesion: 0.67
...
### Community 187 - "inviaMessaggio"
Cohesion: 0.22
Nodes (11): aggiornaListaGiorno(), aggiornaPrenotazioni(), aggiornaReport(), aggiornaSemaforo(), aggiungiBollaChat(), colorePrenotazione(), inizializzaCalendarioPrenotazioni(), inviaMessaggio() (+3 more)
...
### Community 190 - "secondary-foreground"
Cohesion: 0.67
...
### Community 201 - "validate_data.py"
Cohesion: 0.83
...
## Knowledge Gaps
- **1327 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `fs`, `path`, `fs` (+1322 more)
...
- **Why does `Repository` connect `Repository` to `test_reviews_api.py`, `test_hitl_repository.py`, `main.py`, `whatsapp/conftest.py`, `scheduler.py`, `apply_status_update`, `inbox/test_routes.py`, `inbox/routes.py`, `AppConfig`, `test_repository.py`, `gdpr/routes.py`, `test_gdpr_fk.py`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `CoreRepository` connect `CoreRepository` to `BookingService`, `main.py`, `reviews/routes.py`, `core/conftest.py`, `scheduler.py`, `time`, `email_service.py`, `AppConfig`, `gdpr/routes.py`, `test_gdpr_fk.py`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `TailwindConfigGenerator` connect `TailwindConfigGenerator` to `test_tailwind_config_gen.py`, `.generate_config_string`, `.test_add_breakpoints`, `.test_init_default_typescript`, `.test_generate_javascript_config`, `.test_generate_config_with_plugins`, `.test_write_config_invalid_path`, `.test_validate_config_empty_theme`, `.test_write_config`, `.test_init_framework`, `.test_default_content_paths_react`, `.test_default_content_paths_nextjs`, `TestTailwindConfigGenerator`, `._base_config`, `main`?**
