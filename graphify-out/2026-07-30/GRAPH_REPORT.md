# Graph Report - whatsapp-ai-responder  (2026-07-29)

## Corpus Check
- 283 files · ~681,844 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3632 nodes · 5273 edges · 255 communities (221 shown, 34 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 130 edges (avg confidence: 0.64)
...
- `_get_booking_service()` --indirect_call--> `booking_service()`  [INFERRED]
  src/core/bookings/routes.py → tests/core/bookings/conftest.py
- `TestMetaClient` --uses--> `OutboundTextPayload`  [INFERRED]
  tests/whatsapp/test_client.py → src/whatsapp/models.py
- `TestMetaClient` --uses--> `SendTextRequest`  [INFERRED]
  tests/whatsapp/test_client.py → src/whatsapp/models.py
...
### Community 3 - "main.py"
Cohesion: 0.10
Nodes (38): middleware, carica_documento(), carica_file_documento(), conteggio_documenti(), elenca_configurazioni(), health_check(), ottieni_dashboard(), ottieni_disponibilita() (+30 more)

### Community 4 - "InboundProcessor"
Cohesion: 0.06
Nodes (36): security_audit(), InboundProcessor, contact(), org_id(), asyncio, fixture, test_consent_status_deleted_contact_returns_none(), test_contact_default_consent() (+28 more)
...
Cohesion: 0.10
Nodes (38): Enum, costruisci_system_prompt(), costruisci_user_prompt(), formatta_cronologia(), prompts.py ---------- Qui costruiamo il testo che l'agente riceve come…, Trasforma gli ultimi N scambi in testo per il prompt., Genera le istruzioni di ruolo per l'agente, basate sul profilo dell'attività…, Il messaggio del cliente così com'è, con la data odierna per risolvere date… (+30 more)

### Community 10 - "Repository"
Cohesion: 0.05
Nodes (5): UUID, Atomically marks a message as replied+handled. Returns the updated row if this…, Periodic heartbeat — tells the reaper this claim is still alive., Libera i claim rimasti bloccati oltre timeout_minutes. Per i messaggi usa…, Repository
...
Cohesion: 0.12
Nodes (27): retry, ButtonReply, ChangeEntry, ChangeValue, ContactEntry, ContactResponse, ContextEntry, Entry (+19 more)
...
Cohesion: 0.19
Nodes (5): MetaClient, RetryWorker, mock, TestMetaClient, TestRetryWorker
...
Cohesion: 0.27
Nodes (14): costruisci_system_prompt_report(), costruisci_user_prompt_report(), crea_report_agent(), crea_report_crew(), crea_report_task(), Agent, Crew, Task (+6 more)
...
Cohesion: 0.15
Nodes (17): callable, SentenceTransformer, chiedi_documenti(), elenco_documenti(), _modello(), vettorizza(), rispondi(), aggiungi() (+9 more)
...
Cohesion: 0.13
Nodes (23): _imposta_fonte_dati_per_scheduler(), lifespan(), FastAPI, close_http_client(), run_retention(), avvia_scheduler(), _calendar_sync_job(), ferma_scheduler() (+15 more)
...
Cohesion: 0.21
Nodes (10): enqueue_escalation(), EscalationEvent, _get_smtp_config(), retry, _send_with_retry(), start_worker(), stop_worker(), _worker() (+2 more)
...
### Community 90 - "post"
Cohesion: 0.22
Nodes (13): crea_prenotazione(), indicizza_documenti(), _prossimo_id(), post, ricevi_messaggio(), ricevi_recensione(), test_email(), crea_prenotazione_dashboard() (+5 more)
...
### Community 131 - "bookings/routes.py"
Cohesion: 0.36
Nodes (16): cancel_booking(), confirm_booking(), create_booking(), get_booking(), _get_booking_service(), get_settings(), list_bookings(), mark_completed() (+8 more)
...
### Community 144 - "TenantConfig"
Cohesion: 0.23
Nodes (10): Exception, TenantConfig, MessageBlockedByOptOut, MessageUsageExceeded, UUID, app_config(), mock_repo(), mock_service() (+2 more)
...
### Community 149 - "bookings/test_routes.py"
Cohesion: 0.17
...
Cohesion: 0.62
Nodes (5): _estrai_immagine(), _estrai_pdf_scansionato(), estrai_testo(), _ocr_immagine(), ValueError

### Community 159 - "bookings/conftest.py"
Cohesion: 0.60
Nodes (4): booking_service(), fixture, settings(), tomorrow()
...
### Community 186 - "test_hitl_repository.py"
Cohesion: 0.53
...
### Community 220 - "secondary-foreground"
Cohesion: 0.67
...
- **Why does `Repository` connect `Repository` to `_headers`, `main.py`, `TestInboxAPI`, `whatsapp/conftest.py`, `scheduler.py`, `apply_status_update`, `inbox/routes.py`, `AppConfig`, `test_repository.py`, `gdpr/routes.py`, `test_gdpr_fk.py`, `test_hitl_repository.py`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `CoreRepository` connect `CoreRepository` to `main.py`, `core/conftest.py`, `scheduler.py`, `time`, `email_service.py`, `AppConfig`, `webhook_handler.py`, `gdpr/routes.py`, `test_gdpr_fk.py`?**
